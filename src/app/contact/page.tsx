        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="contact-grid">
            ...
            <div className="contact-hero-text">
              ...
              <div className="flex flex-col gap-6 contact-info-cards">
                {[
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div className="contact-name-email">
                  <div>
                    ...
                    <input required style={inputStyle} type="text" placeholder="Rahul Sharma" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} />
                  </div>
                  <div>
                    <label className="label-sm" style={{ display: "block", marginBottom: "8px", color: "#888" }}>Email *</label>
                    <input required style={inputStyle} type="email" placeholder="rahul@company.com" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} />
                  </div>
                </div>

                <div>
                  <label className="label-sm" style={{ display: "block", marginBottom: "8px", color: "#888" }}>Phone Number</label>
                  <input style={inputStyle} type="tel" placeholder="+91 98765 43210" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} />
                </div>

                <div>
                  <label className="label-sm" style={{ display: "block", marginBottom: "8px", color: "#888" }}>Service Interested In *</label>
                  <select required style={inputStyle} value={form.service} onChange={e => setForm({ ...form, service: e.target.value })}>
                ...
                <div>
                  ...
                  <textarea required style={{ ...inputStyle, resize: "none" }} rows={4} placeholder="What does your business do? What goals are you trying to achieve?" value={form.message} onChange={e => setForm({ ...form, message: e.target.value })} />
                </div>

                <button
                  type="submit"
                  className="btn-primary btn-magenta"
                  style={{ padding: "16px", fontSize: "15px", width: "100%", justifyContent: "center" }}
